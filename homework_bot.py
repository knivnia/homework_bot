...
PRACTICUM_TOKEN = os.getenv('PRACTICUM_TOKEN') # API key
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN') # Telegram token (obtained via Bot Father)
TELEGRAM_CHAT_ID = os.getenv('TELEGRAM_CHAT_ID') # personal Telegram ID (obtained via https://t.me/userinfobot)
